...
the autocorrelation function for a given MA(2) process and plot it against lag:
    ...
    plot_rho <- function(theta_1, theta_2, k_vals) {
    ...
    a. Plot for $\theta_1 = 0.5$, $\theta_2 = 0.4$:
        ...
        ```{r}
        plot_rho(0.5, 0.4, 1:10)
        ```

    b. Plot for $\theta_1 = 1.2$, $\theta_2 = -0.7$:
    
        ```{r}
        plot_rho(1.2, -0.7, 1:10)
        ```
...
6.
    ...
    of $Y_{t-1}$ and $Y_{t-2}$. Then to prove stationarity it suffices to show
    that each of the solutions $x$ to the AR characteristic equation
